...
public class CustomLogoutFilter extends GenericFilterBean {
    ...
    public CustomLogoutFilter(JWTUtil jwtUtil, JwtTokenServiceImpl jwtTokenServiceImpl) {
...
/*
        if (username.startsWith("naver")) {
            ...
            if (access != null) {
                logoutFromOAuthProvider(access);
            }
        }*/
        ...
        if (username != null) {
            jwtTokenServiceImpl.updateLogoutTime(username);
        }
        response.setStatus(HttpServletResponse.SC_OK);
    }
/*
    private void logoutFromOAuthProvider(String accessToken) {
