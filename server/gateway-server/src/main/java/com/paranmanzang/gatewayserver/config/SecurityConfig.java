    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) throws Exception {
        http
                ...
                .authorizeExchange(auth -> auth
                        ...
                        .pathMatchers("/login", "/oauth2/**", "/api/users", "/api/users/checkPassword", "/api/users/checkNickname", "/api/users/checkRole", "/api/users/updateDeclaration", "/api/users/updateLogoutUserTime", "/reissue").permitAll()  // /login과 /oauth2/** 경로는 인증 없이 접근 가능
                        ...
                        .pathMatchers("/api/rooms/{id}").hasAnyAuthority(Role.ROLE_SELLER.getCode(), Role.ROLE_ADMIN.getCode())
